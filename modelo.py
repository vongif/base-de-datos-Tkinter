...
class CreacionDeDatos:
    def base():
        con = sqlite3.connect("base_ejemplo.db")
        return con


class ConexionBaseDeDatos(CreacionDeDatos):
    def crear_tabla():
        con = CreacionDeDatos.base()
        cursor = con.cursor()
...
try:
    CreacionDeDatos.base()
    ConexionBaseDeDatos.crear_tabla()
except:
    print("Hay un error")
